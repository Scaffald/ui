...
<LivePreview code={`<ThemeProvider initialTheme="light">
  <Accordion defaultValue="item1">
    <Accordion.Item value="item1">
      ...
      <Accordion.Content>
        <Text>Scaffald UI is a production-ready component library for React Native and Web.</Text>
      </Accordion.Content>
    </Accordion.Item>
    <Accordion.Item value="item2">
      <Accordion.Trigger>How do I install it?</Accordion.Trigger>
      <Accordion.Content>
        <Text>Run npm install @scaffald/ui in your project.</Text>
      </Accordion.Content>
    </Accordion.Item>
    <Accordion.Item value="item3">
      <Accordion.Trigger>Is it cross-platform?</Accordion.Trigger>
      <Accordion.Content>
        <Text>Yes! It works on iOS, Android, and Web.</Text>
      </Accordion.Content>
    </Accordion.Item>
  </Accordion>
</ThemeProvider>`} />
