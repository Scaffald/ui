...
<LivePreview code={`<ThemeProvider initialTheme="light">
  <Text>The ScrollArea component provides a styled scrollable container with custom scrollbar appearance. It wraps content that may overflow its container and provides consistent cross-platform scroll behavior.</Text>
</ThemeProvider>`} />
