/**
 * Toggle component
 * Switch with a smooth thumb-slide animation, driven by vanilla `Animated`
...
export function Toggle({
  ...
  const thumbPosition = useRef(
    new Animated.Value(checked ? sizeConfig.thumbTranslate : 0)
  ).current

  useEffect(() => {
    const target = checked ? sizeConfig.thumbTranslate : 0
    ...
    Animated.spring(thumbPosition, {
      ...
      mass: springConfigs.snappy.mass,
